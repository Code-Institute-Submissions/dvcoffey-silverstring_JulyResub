...
The color scheme mainly consists of grey white black and an approximation of dark wood. 
The background is a blue to dark brown/gold gradient that exists across the entire site.
I chose these colors because I believe mimic the imagery of the luthiers workshop. 
